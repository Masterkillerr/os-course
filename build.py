...
# emoji -> icon name, based on what's actually used in Robles/*.md frontmatter + headings.
_EMOJI_ICON = {
    ...
    "⚠️": "triangle-alert", "⚠": "triangle-alert", "🌐": "globe", "🎯": "target",
    "📋": "list-checks", "📖": "book-open", "📝": "notebook-text", "🔗": "link",
}
